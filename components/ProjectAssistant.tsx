...
export function ProjectAssistant({
  ...
  const projectSlug = providedProjectSlug ?? routeProjectSlug;
  ...
  if (embedded) {
    return (
      <section className="rounded-[2rem] border border-white/70 bg-white/90 shadow-card">
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-5 py-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-pine">{title}</p>
